 ...
 * @author yelz
 */
public class MyApi extends LfApi {
    ...
    public void pos_setType(int type) {
        if (type == 0) {
            ...
            pmLfPosApiMispos.setType((byte) 0x92);//杉德会员卡
        } else if (type == 93) {
            pmLfPosApiMispos.setType((byte) 0x93);//杉德O2O平台
        } else {
            pmLfPosApiMispos.setType((byte) 0x01);
        }
    }
    ...
    public void setTmsServer(String ip, int port) {
        pmLfPosApiMispos.setTmsServer(ip, port);
    }

    public void setAutoSettle(boolean isAuto) {
        pmLfPosApiMispos.setAutoSettle(isAuto);//自动结算
    }

    public void setAutoTms(boolean isAuto) {
        pmLfPosApiMispos.setAutoTms(isAuto);//自动TMS升级
    }

    public void pos_netdisconnect(boolean isConnect) {
        pmLfPosApiMispos.disConnect(isConnect);
    }
    ...
    public void setPOSISerialPort(ISerialPort pISerialPort) {
        pmLfPosApiMispos.setPOSISerialPort(pISerialPort);
    }
    ...
    public E_REQ_RETURN pos_init(String pospIP, int port, String path, String baud) {//
        ...
        synchronized (lockApi) {
            ...
            this.pospIP = pospIP;
            this.pospPort = port;
            pmLfPosApiMispos.EnableDBG();//设置dbg输出
            pmLfPosApiMispos.setPOSISerialPort(null);//设置串口接口,null为默认的串口jni
            pmLfPosApiMispos.setIDisplay(mIDisplay);  //设置信息提示回调接口
            pmLfPosApiMispos.setPara(path, baud); //设置串口参数
            pmLfPosApiMispos.setPosServer(this.pospIP, this.pospPort);//设置服务器参数
            pmLfPosApiMispos.setAutoSettle(true);//自动结算
            pmLfPosApiMispos.setAutoTms(true);//自动TMS升级
...
//        }
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                try {
                    ...
                    mREPLY = pmLfPosApiMispos._07_Confirm(t);//发起请求
                    err_code = CheckNAK(mREPLY);
                    //设置正常返回结果
                    msg.arg2 = 0;
                    reply = mREPLY.reply == MISPOS.PACK_ACK ? 0 : 1;
     ...
     * @return
     */
    private E_REQ_RETURN pos_base(final E_OP_TYPE optype) {
        Logz.i(TAG, "return busy,state_op:" + state_op + ",_IsBusy:" + pmLfPosApiMispos._IsBusy());
...
//                                t.setTimeout((byte) 120);
                                ...
                                mREPLY = pmLfPosApiMispos._03_GetRecordReply(t);
                                ...
                                mREPLY = pmLfPosApiMispos._03_GetPrintInfo(t);
                                obj = (_04_GetPrintInfoReply) mREPLY;
                                ////////////////////////////////////////////////////////////////////
                            } else if (zn_op_type == E_OP_TYPE.OP_POS_QUERY) {
                                pos_setType(0);
                                t.setTradeType(TradeType.QUERY);
                                mREPLY = pmLfPosApiMispos._03_Query(t);
                                ...
                                mREPLY = pmLfPosApiMispos._03_Recharge(t);
                                obj = (_04_PurchaseReply) mREPLY;
                                ////////////////////////////////////神思饭卡////////////////////////////////
                                ...
                                mREPLY = pmLfPosApiMispos._03_ZN_Withdraw((_03_Withdraw) t);
                                obj = mREPLY;
                                ...
                                mREPLY = pmLfPosApiMispos._03_Get_CardReader((_03_GetCardReader) t);
                                obj = mREPLY;
                                ...
                                mREPLY = pmLfPosApiMispos._03_ZN_Cashrem((_03_Cashrem) t);
                                obj = mREPLY;
                                ...
                                mREPLY = pmLfPosApiMispos._03_ZN_Transferrem((_03_Transferrem) t);
                                obj = mREPLY;
                                ...
                                mREPLY = pmLfPosApiMispos._03_ZN_PassbookRenew((_03_PassbookRenew) t);
                                ...
                                mREPLY = pmLfPosApiMispos._03_ZN_DownloadAppcode((_03_DownloadAppcode) t);//发起请求
                                ...
                                mREPLY = pmLfPosApiMispos._03_ZN_GetZNRecordInfo((_03_GetZNRecordInfo) t);//发起请求
                                ...
                                mREPLY = pmLfPosApiMispos._03_ZN_ReadCardNo((_03_ReadCardNo) t);//发起请求
                                ...
                                mREPLY = pmLfPosApiMispos._03_ZN_ReadAccountName((_03_ReadAccountName) t);//发起请求
                                ...
                                mREPLY = pmLfPosApiMispos._03_ZN_PayfeesQuery((_03_PayfeesQuery) t);//发起请求
                                ...
                                mREPLY = pmLfPosApiMispos._03_ZN_Payfees((_03_Payfees) t);//发起请求
                                obj = mREPLY;
                                ...
                                mREPLY = pmLfPosApiMispos._03_ZN_BoundAccountQuery((_03_BoundAccountQuery) t);//发起请求
                                ...
                                mREPLY = pmLfPosApiMispos._03_ZN_PassbookToCard((_03_PassbookToCard) t);
                                obj = mREPLY;
                                ...
                                mREPLY = pmLfPosApiMispos._03_ZN_TestWithdraw((_03_TestZNWithdraw) t);
                                obj = mREPLY;
                                ...
                                mREPLY = pmLfPosApiMispos._03_ZN_TestGetZNRecordInfo((_03_TestGetZNRecordInfo) t);
                                ...
                                mREPLY = pmLfPosApiMispos._03_ZN_TestTransferrem((_03_TestZNTransferrem) t);
                                obj = mREPLY;
                                ...
                                mREPLY = pmLfPosApiMispos._03_ZN_CheckBalance((_03_CheckBalance) t);
                                obj = mREPLY;
                                ...
                                mREPLY = pmLfPosApiMispos._03_GetTransQuery((_03_TransQuery) t);
                                obj = (_04_TransQueryReply) mREPLY;
                            } else if (zn_op_type == E_OP_TYPE.OP_POS_SEND_TMK) {
                                t = new _03_SendTMK();
                                t.setTradeType(TradeType.SEND_TMK);
                                mREPLY = pmLfPosApiMispos._03_Test_SendTMK((_03_SendTMK) t);
                                obj = mREPLY;
                                ...
                                mREPLY = pmLfPosApiMispos._03_ZN_SetPara((_03_SetMerTmn) t);
                                obj = mREPLY;
                                ////////////////////////////////////厦门停车场////////////////////////////////
                                ...
                                mREPLY = pmLfPosApiMispos._03_PosCSBTrade((_03_PosCSBTrade) t);
                                obj = mREPLY;
                                ...
                                mREPLY = pmLfPosApiMispos._03_Preauthor((_03_PreAuthorization) t);
                                obj = mREPLY;
                                ...
                                mREPLY = pmLfPosApiMispos._03_PreauthorCancel((_03_PreAuthorCancel) t);
                                obj = mREPLY;
                                ...
                                mREPLY = pmLfPosApiMispos._03_PreauthorCancel((_03_PreAuthorDone) t);
                                obj = mREPLY;
                                ...
                                mREPLY = pmLfPosApiMispos._03_PreauthorDoneCancel((_03_PreAuthorDoneCancel) t);
                                obj = mREPLY;
                                ////////////////////////////////////杉德////////////////////////////////
                                ...
                                mREPLY = pmLfPosApiMispos._03_SandSmall((_03_SandSmall) t);
                                obj = mREPLY;
                                ...
                                mREPLY = pmLfPosApiMispos._03_SandBscPay((_03_SandBscPay) t);
                                obj = mREPLY;
                                ...
                                mREPLY = pmLfPosApiMispos._03_SandBscRefund((_03_SandBscRefund) t);
                                obj = mREPLY;
                                ...
                                mREPLY = pmLfPosApiMispos._03_SandBscReturn((_03_SandBscReturn) t);
                                obj = mREPLY;
                                ...
                                mREPLY = pmLfPosApiMispos._03_SandO2OQrCodeTrade((_03_SandO2OQrCodeTrade) t);
                                obj = mREPLY;
                                ...
                                mREPLY = pmLfPosApiMispos._03_SandO2OQrCodeQuery((_03_SandO2OQrCodeQuery) t);
                                obj = mREPLY;
                                ...
                                mREPLY = pmLfPosApiMispos._03_SandO2OLoop((_03_SandO2OLoop) t);
                                obj = mREPLY;
                                ...
                                mREPLY = pmLfPosApiMispos._03_SandO2OResult((_03_SandO2OResult) t);
                                obj = mREPLY;
                                ...
                                mREPLY = pmLfPosApiMispos._03_SandO2OCandel((_03_SandO2OCancel) t);
                                obj = mREPLY;
                            ...
                            if (optype.getDesc().equals(E_OP_TYPE.OP_POS_SIGNIN.getDesc()) && mREPLY.code_info.equals("交易成功")) {
                                zn_op_type = E_OP_TYPE.OP_POS_SIGNIN;
                                mREPLY.code_info = "签到操作,交易成功";
                                dpl.setType(mREPLY.code);
                                dpl.setMsg("签到操作,交易成功");
                            } else if (optype.getDesc().equals(E_OP_TYPE.OP_POS_PURCHASE.getDesc()) && mREPLY.code_info.equals("交易成功")) {
