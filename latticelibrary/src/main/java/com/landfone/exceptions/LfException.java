package com.landfone.exceptions;
...
public class LfException extends Exception {
    ...
    public LfException(String ErrorMessagr) {  //父类方法
        errcode = 0;
        message = ErrorMessagr;
    }

    public LfException(int errcode, String ErrorMessagr) {  //父类方法
        //this.e = new Exception();
        message = ErrorMessagr;
        this.errcode = errcode;
    }

    public LfException(Exception pe, int errcode, String ErrorMessagr) {  //父类方法
        message = ErrorMessagr;
        this.errcode = errcode;
        this.e = pe;
    }
