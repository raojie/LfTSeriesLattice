...
/**
 * Method: SecondShowTextWindowDownlink
 * Decription:
 * Author: raoj
 * Date: 2017/9/7
 **/
public class SecondShowTextWindowDownlink extends DownlinkBaseDeviceProtocolInitiative {

    public SecondShowTextWindowDownlink() {
        ...
        setResidenceTime(new byte[]{0x01});
        setWhetherCleared(new byte[]{0x00});
        setContentLayout(new byte[]{0x01});
