...
/**
 * Method: ThirdShowTextWindowDownlink
 * Decription:
 * Author: raoj
 * Date: 2017/9/7
 **/
public class ThirdShowTextWindowDownlink extends DownlinkBaseDeviceProtocolInitiative {

    public ThirdShowTextWindowDownlink() {
